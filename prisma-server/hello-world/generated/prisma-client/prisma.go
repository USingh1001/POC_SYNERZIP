...
var DefaultEndpoint = "https://us1.prisma.sh/udnsingh1001/poc-service/poc-dev"
var Secret          = ""
      ...
      func (client *Client) Book (params BookWhereUniqueInput) *BookExec {
        ret := client.Client.GetOne(
          ...
          "book",
          []string{"id","isbn","title","subtitle","author","published","publisher","pages","description","website"})
...
BookOrderByInputIsbnAsc BookOrderByInput = "isbn_ASC"
BookOrderByInputIsbnDesc BookOrderByInput = "isbn_DESC"
BookOrderByInputTitleAsc BookOrderByInput = "title_ASC"
BookOrderByInputTitleDesc BookOrderByInput = "title_DESC"
BookOrderByInputSubtitleAsc BookOrderByInput = "subtitle_ASC"
BookOrderByInputSubtitleDesc BookOrderByInput = "subtitle_DESC"
BookOrderByInputAuthorAsc BookOrderByInput = "author_ASC"
BookOrderByInputAuthorDesc BookOrderByInput = "author_DESC"
BookOrderByInputPublishedAsc BookOrderByInput = "published_ASC"
BookOrderByInputPublishedDesc BookOrderByInput = "published_DESC"
BookOrderByInputPublisherAsc BookOrderByInput = "publisher_ASC"
BookOrderByInputPublisherDesc BookOrderByInput = "publisher_DESC"
BookOrderByInputPagesAsc BookOrderByInput = "pages_ASC"
BookOrderByInputPagesDesc BookOrderByInput = "pages_DESC"
...
BookOrderByInputWebsiteAsc BookOrderByInput = "website_ASC"
BookOrderByInputWebsiteDesc BookOrderByInput = "website_DESC"
          )
...
Isbn *string `json:"isbn,omitempty"`
IsbnNot *string `json:"isbn_not,omitempty"`
IsbnIn []string `json:"isbn_in,omitempty"`
IsbnNotIn []string `json:"isbn_not_in,omitempty"`
IsbnLt *string `json:"isbn_lt,omitempty"`
IsbnLte *string `json:"isbn_lte,omitempty"`
IsbnGt *string `json:"isbn_gt,omitempty"`
IsbnGte *string `json:"isbn_gte,omitempty"`
IsbnContains *string `json:"isbn_contains,omitempty"`
IsbnNotContains *string `json:"isbn_not_contains,omitempty"`
IsbnStartsWith *string `json:"isbn_starts_with,omitempty"`
IsbnNotStartsWith *string `json:"isbn_not_starts_with,omitempty"`
IsbnEndsWith *string `json:"isbn_ends_with,omitempty"`
IsbnNotEndsWith *string `json:"isbn_not_ends_with,omitempty"`
...
PublishedNot *string `json:"published_not,omitempty"`
PublishedIn []string `json:"published_in,omitempty"`
PublishedNotIn []string `json:"published_not_in,omitempty"`
PublishedLt *string `json:"published_lt,omitempty"`
PublishedLte *string `json:"published_lte,omitempty"`
PublishedGt *string `json:"published_gt,omitempty"`
PublishedGte *string `json:"published_gte,omitempty"`
PublishedContains *string `json:"published_contains,omitempty"`
PublishedNotContains *string `json:"published_not_contains,omitempty"`
PublishedStartsWith *string `json:"published_starts_with,omitempty"`
PublishedNotStartsWith *string `json:"published_not_starts_with,omitempty"`
PublishedEndsWith *string `json:"published_ends_with,omitempty"`
PublishedNotEndsWith *string `json:"published_not_ends_with,omitempty"`
Publisher *string `json:"publisher,omitempty"`
PublisherNot *string `json:"publisher_not,omitempty"`
PublisherIn []string `json:"publisher_in,omitempty"`
PublisherNotIn []string `json:"publisher_not_in,omitempty"`
PublisherLt *string `json:"publisher_lt,omitempty"`
PublisherLte *string `json:"publisher_lte,omitempty"`
PublisherGt *string `json:"publisher_gt,omitempty"`
PublisherGte *string `json:"publisher_gte,omitempty"`
PublisherContains *string `json:"publisher_contains,omitempty"`
PublisherNotContains *string `json:"publisher_not_contains,omitempty"`
PublisherStartsWith *string `json:"publisher_starts_with,omitempty"`
PublisherNotStartsWith *string `json:"publisher_not_starts_with,omitempty"`
PublisherEndsWith *string `json:"publisher_ends_with,omitempty"`
PublisherNotEndsWith *string `json:"publisher_not_ends_with,omitempty"`
Pages *int32 `json:"pages,omitempty"`
PagesNot *int32 `json:"pages_not,omitempty"`
PagesIn []int32 `json:"pages_in,omitempty"`
PagesNotIn []int32 `json:"pages_not_in,omitempty"`
PagesLt *int32 `json:"pages_lt,omitempty"`
PagesLte *int32 `json:"pages_lte,omitempty"`
PagesGt *int32 `json:"pages_gt,omitempty"`
PagesGte *int32 `json:"pages_gte,omitempty"`
...
Not []UserSubscriptionWhereInput `json:"NOT,omitempty"`
        ...
        var BookFields = []string{"id", "isbn", "title", "subtitle", "author", "published", "publisher", "pages", "description", "website"}
...
UpdatedFields []string `json:"updatedFields,omitempty"`
        ...
        var BookPreviousValuesFields = []string{"id", "isbn", "title", "subtitle", "author", "published", "publisher", "pages", "description", "website"}
